...
matchedPathDataCat= [matchedPathDataGM(:,:,1) matchedPathDataGM(:,:,2)];
...
matchedThicknessDataCat= [matchedThicknessData(:,:,1) matchedThicknessData(:,:,2)];
...
plotNetwork3(cmpCovTDP_gt_Tau, schaefer400x7SurfaceMeshFromGII, currCoM,LabelNames,cRange,MakerVec,panelAll,1,colorVec,0)
plotNetwork3(cmpCovTau_gt_TDP, schaefer400x7SurfaceMeshFromGII, currCoM,LabelNames,cRange,MakerVec,panelAll,2,colorVec,0)
