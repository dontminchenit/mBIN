inT = readtable('D:/Min/Dropbox (Personal)/Research/Projects/FTD/FTDAnalysis/Data/Final_Network_Path_Sheet_5_7_21_wCore.xlsx');
...
%GM+WM Graph
baseSaveDir = './PaperExpCore_6_25_2021/GM+WM/';
mkdir(baseSaveDir);
...
%GM Graph
baseSaveDir = './PaperExpCore_6_25_2021/GM/';
mkdir(baseSaveDir);
...
%WM Graph
baseSaveDir = './PaperExpCore_6_25_2021/WM/';
mkdir(baseSaveDir);
...
baseSaveDir = './PaperExpCore_6_25_2021/';
