...
saveDir = './PaperExpCore_3_23_2021/NetMetricsBin9/';
mkdir(saveDir);

thresh = .9;

TauGMMtxM = calcNetworkMetricsBin(TauGMMtx,thresh);
TDPGMMtxM = calcNetworkMetricsBin(TDPGMMtx,thresh);
H=figure(1)
clf
...
TauWMMtxM = calcNetworkMetricsBin(TauWMMtx,thresh);
TDPWMMtxM = calcNetworkMetricsBin(TDPWMMtx,thresh);
...
TauAllMtxM = calcNetworkMetricsBin(TauAllMtx,thresh);
TDPAllMtxM = calcNetworkMetricsBin(TDPAllMtx,thresh);
