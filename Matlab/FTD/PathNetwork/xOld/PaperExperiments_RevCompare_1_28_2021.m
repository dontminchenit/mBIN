...
%GM+WM Graph
SaveDir = './PaperRevComp_1_28_2022/GM+WM/';
mkdir(SaveDir);
...
%GM Graph
SaveDir = './PaperRevComp_1_28_2022/GM/';
mkdir(SaveDir);
...
[GMTauNetworkBurdenCorr,GMTDPNetworkBurdenCorr,MarkerNames,MarkerSizeTauAll,MarkerSizeTDPAll]=analyzeGraphsSubGroup(inT,tidxCoreGM,removeRegions,SaveDir,1,[],TauSubTypes{q},TDPSubTypes{q});

%WM Graph
SaveDir = './PaperRevComp_1_28_2022/WM/';
mkdir(SaveDir);
...
[WMTauNetworkBurdenCorr,WMTDPNetworkBurdenCorr,MarkerNames,MarkerSizeTauAll,MarkerSizeTDPAll]=analyzeGraphsSubGroup(inT,tidxCoreWM,removeRegions,SaveDir,1,[],TauSubTypes{q},TDPSubTypes{q});
...
SaveDir = './PaperRevComp_1_28_2022/';
