...
for i = 2
    ...
    for g1=1:3
        for g2=1:3
            ...
            plotBrain3Points(CoM,Lausanne250SurfaceMeshFromGII,data,0,panelAll,plotg1(1),1)
    ...
    for jj = 1:3
        ...
        g2 = compGroup2(jj);
            ...
            CRange = [-1.5 1.5];
            if jj == 3
                plotBrain3Points(CoM,Lausanne250SurfaceMeshFromGII,data,0,panelAll,plotg1((jj)+1),3) %force a new colomap for the last comparison
            else
                plotBrain3Points(CoM,Lausanne250SurfaceMeshFromGII,data,0,panelAll,plotg1((jj)+1),6)
            end

    end
    
           print(H2,fullfile(saveDirBase,'fig4_between.tif'),'-dpng','-r400'); 
