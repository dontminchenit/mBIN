function [AllResults, outTable] = LoadNetworkDataSarah(inInfo,NetDataDir,outTableSaveFile,outMatSaveFile)
...
for i = 1:N
    ...
    AllResults.Thickness.Median(i,:) = currThickVals{strcmpi(currThickVals.system,'lausanne250') & strcmpi(currThickVals.measure,'thickness') & strcmpi(currThickVals.metric,'median'),'value'};
    AllResults.Thickness.Mean(i,:) = currThickVals{strcmpi(currThickVals.system,'lausanne250') & strcmpi(currThickVals.measure,'thickness') & strcmpi(currThickVals.metric,'mean'),'value'};
