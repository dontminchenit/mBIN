function [AllResults, outTable] = LoadNetworkDataSubNetwork(inInfo,NetDataDir,outTableSaveFile,outMatSaveFile,SubNet)
...
for GraphEdgeType = 2
    ...
    for i = 1:N
        ...
        %set weight and length matrices but only for subnetwork
        W=currAdjMtx(SubNet,SubNet);
