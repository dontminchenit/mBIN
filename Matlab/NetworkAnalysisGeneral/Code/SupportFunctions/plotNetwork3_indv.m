function plotNetwork3_indv(adjMtx, GIImesh, CoM,LabelNames,cRange,MakerVec,panelAll,pSelectCol,pSelectRow,colorVec,blue0orng1brwn2jet3,surfDisp)
%,UnderlayData)
...
for v = 1
    ...
    panelAll(pSelectRow,pSelectCol).select();
