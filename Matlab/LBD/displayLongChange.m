...
ii
        ...
        for i = 1:length(numTimePoints)
            ...
            meanthickyrLast(i,:)=AllResults.Thickness.Mean(i,:,2);
            LastYrFromBaseline(i)=YrFromBaseline(i,2);
        end

        thickyesADyr1 = AllResults.Thickness.Mean(demoT.LBD0_LBDAD1 == 1,:,1);
        %thickyesADyr2 = AllResults.Thickness.Mean(demoT.LBD0_LBDAD1 == 1,:,2);
        ...
        thickyesMeanChange(thickyesMeanChange>=0)=0;
        ...
        thicknoMeanChange(thicknoMeanChange>=0)=0;

        plotBrain3Points(NetworkDataGeneral.Schaefer400x7.CoM,NetworkDataGeneral.Schaefer400x7.GII,thickyesMeanChange,0,panelAll,1,2,10)
